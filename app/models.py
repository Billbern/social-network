...
class User(db.Model):
    ...
    password = db.Column(db.String(100), index=False, unique=True, nullable=False)
...
class Profile(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    firstname = db.Column(db.String(96), nullable=False)
    lastname = db.Column(db.String(96), nullable=False)
